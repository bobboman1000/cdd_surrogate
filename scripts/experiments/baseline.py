...
if __name__ == '__main__':
    ...
    run(data, "stress", ["strain", "time_ns", "dislocation"], prefix + "stress" + suffix, gbt_jobs, cvmult, num_folds, batch_size)
    run(data, "strain", ["stress", "time_ns", "dislocation"], prefix + "strain" + suffix, gbt_jobs, cvmult, num_folds, batch_size)
    run(data, "dislocation", ["time_ns", "stress", "strain"], prefix + "dislocation" + suffix, gbt_jobs, cvmult, num_folds, batch_size)
